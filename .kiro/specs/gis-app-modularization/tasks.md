...
- [ ] 2. Create map manager module (keeping script.js intact)

  - [-] 2.1 Create js/core/map-manager.js for map initialization




    - Extract ONLY map initialization logic from script.js (initializeMap function)
    - Create MapManager class that encapsulates map and view creation
    - **DO NOT extract utility functions yet** - keep them in script.js
    - Preserve all global variables (displayMap, view) for compatibility
    - _Requirements: 1.2, 1.4, 1.5_
  
  - [ ] 2.2 Update main.js to use MapManager alongside script.js

    - Import and initialize MapManager in main.js
    - **Keep script.js loading** to provide utility functions and globals
    - Ensure both systems work together without conflicts
    - Test that map initializes correctly with hybrid approach
    - _Requirements: 1.1, 1.4, 1.5_
  
  - [ ] 2.3 Verify map functionality with dual system

    - Test all existing map features work correctly
    - Verify global variables are accessible to both systems
    - Ensure no breaking changes in map initialization
    - _Requirements: 1.1_

- [ ] 3. Extract UI component modules (using script.js functions)
  - [ ] 3.1 Create js/ui/toolbar.js for toolbar functionality
    ...
    - **Use script.js utility functions** via window.functionName during transition
  ...
  - [ ] 3.2 Create js/ui/panels.js for side panel management
    ...
    - **Use script.js utility functions** for notifications and formatting
...
- [ ] 4. Extract layer management modules (using script.js functions)
  ...
  - [ ] 4.2 Create js/layers/upload-handler.js for file processing
    ...
    - **Use script.js utility functions** for notifications and error handling
  ...
  - [ ] 4.3 Create js/layers/basemap-switcher.js for basemap functionality
    ...
    - **Use script.js utility functions** for notifications
    - Maintain all existing basemap options and selection behavior
    - _Requirements: 1.2, 1.4, 3.2_

- [ ] 5. Extract drawing and analysis tool modules (using script.js functions)
  ...
  - [ ] 5.2 Create js/tools/analysis-tools.js for spatial analysis
    ...
    - **Use script.js utility functions** for notifications and calculations
  ...
  - [ ] 5.3 Create js/tools/measurement.js for measurement functionality
    ...
    - **Use script.js utility functions** for formatting and notifications
    - Preserve all existing measurement display and result formatting
    - _Requirements: 1.2, 1.4, 3.2_

- [ ] 6. Extract feature and widget modules (using script.js functions)
  - [ ] 6.1 Create js/features/popup-manager.js for popup functionality
    ...
    - **Use script.js utility functions** for attribute formatting and notifications
...
- [ ] 7. Extract visualization and classification modules (using script.js functions)
...
- [ ] 8. Extract event handling and notification modules (using script.js functions)
  - [ ] 8.1 Create js/events/event-handlers.js for global event coordination
    ...
    - **Use script.js utility functions** for coordinate formatting and notifications
  ...
  - [ ] 8.2 Create js/events/notifications.js for user feedback system
    ...
    - **Use script.js utility functions** for message formatting
    - Maintain all existing notification types and display behavior
    - _Requirements: 1.2, 1.4, 3.2_

- [ ] 9. Create widget management module (using script.js functions)
...
- [ ] 10. Update main.js for complete module integration (with script.js still active)
  - [ ] 10.1 Import all created modules in main.js
    ...
    - **Keep script.js loading** to provide utility functions during transition
    - Ensure all global variables are properly set for backward compatibility
    - _Requirements: 1.1, 1.4, 1.5_
  
  - [ ] 10.2 Verify complete application functionality with hybrid system
    ...
    - **Verify script.js and modules work together** without conflicts
    - _Requirements: 1.1, 3.2, 3.4_

- [ ] 11. Extract utility functions and finalize modularization
  - [ ] 11.1 Create js/utils/utils.js with utility functions
    - **NOW extract** loadModule, formatAttributeValue, formatFieldName, showNotification functions from script.js
    - Export all utility functions using ES6 export syntax
    - Create comprehensive utility module with all helper functions
    - _Requirements: 1.2, 1.3, 1.4_
  
  - [ ] 11.2 Replace script.js dependencies in all modules
    - Update all modules to import utility functions from utils.js instead of using window.functionName
    - Replace script.js function calls with proper module imports
    - Remove global function dependencies from all modules
    - _Requirements: 1.4, 1.5_
  
  - [ ] 11.3 Remove script.js from the application
    - Update index.html to remove script.js loading
    - Ensure main.js no longer depends on script.js
    - Remove or archive the original script.js file
    - _Requirements: 1.1, 1.3, 1.5_
  
  - [ ] 11.4 Final cleanup and optimization
    - Remove any remaining global variables that are no longer needed
    - Optimize module imports and minimize circular dependencies
    - Add proper error handling for module loading failures
    - Verify complete application functionality without script.js
    - _Requirements: 1.1, 1.4, 1.5_
